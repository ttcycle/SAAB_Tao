...
public class AbstractShapeIntersection extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected Ellipsoid shape; // the polygon to intersect
        ...
        public AppFrame()
        {
            ...
            this.shape = new Ellipsoid(Position.fromDegrees(40.5, -120.5, 4e3), 5000, 5000, 5000);
            this.shape.setAltitudeMode(WorldWind.ABSOLUTE);
            //this.shape.setAltitudeMode(WorldWind.RELATIVE_TO_GROUND);
            //this.shape.setAltitudeMode(WorldWind.CLAMP_TO_GROUND);
        ...
        protected void performIntersection(Position pA, Position pB)
        {
            try
            {
                ...
                //Vec4 refPoint = computePointUsingAltitude(pA);
                Vec4 targetPoint = terrain.getSurfacePoint(pB);
                //Vec4 targetPoint = computePointUsingAltitude(pB);
        ...
        protected void drawIntersection(Intersection intersection)
        {
            ...
            //iPoint.setAltitudeMode(WorldWind.ABSOLUTE);
