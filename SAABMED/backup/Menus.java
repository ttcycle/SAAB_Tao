...
public class Menus implements ActionListener, ItemListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().toString().endsWith("Cube")) {
        	System.out.println("CUBE AIRSPACE SELECTED - Press Enter to Finish Placing Airspace");
                ...
                public void keyPressed(KeyEvent evt) {
                    if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                        ...
                        if (placingType == PlacementType.AIRSPACE_BOX) {
                        	...
                        	addAirspace(placingType, pathPositions);
                        	annotationlayer.removeAllAnnotations();
                        	placingType = 0;
                        }
            ...
            wwd.addMouseListener(new MouseAdapter() {
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (placingType == 1) {
                        ...
                        GenericSymbology genericSymbology = new GenericSymbology("New Generic Symbology", "", selectedMenuPath, .5, 1, true, "", "", Position.fromDegrees(latitude, longitude, altitude), new GeoZone("NULL", "", Position.fromDegrees(0, 0), 0));
