 ...
 */
public class Symbols extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            //Creates the symbol (pass parameters)
            this.addTacticalSymbols(34.4934, -117.6003, 3000, "SFAPMFQM------A", "MIL-STD-2525 Tactical Symbol", "My Symbol Layer" );
        ...
        protected void addTacticalSymbols(double latitude, double longitude, double altitude, String symbolCode, String symbolName, String layerName)
        {
        	...
        	// TODO : change this so that it can use an existing layer if needed?
